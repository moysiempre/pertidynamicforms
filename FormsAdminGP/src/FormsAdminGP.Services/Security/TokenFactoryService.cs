...
namespace FormsAdminGP.Services
{
    ...
    public class TokenFactoryService : ITokenFactoryService
    {
        ...
        {
            var refreshTokenSerial = Utils.CreateCryptographicallySecureGuid().ToString().Replace("-", "");

            var claims = new List<Claim>
            {
                // Unique Id for all Jwt tokes
                new Claim(JwtRegisteredClaimNames.Jti, Utils.CreateCryptographicallySecureGuid().ToString(), ClaimValueTypes.String, _configuration.Value.Issuer),
                // Issuer
